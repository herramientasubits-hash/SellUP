  ...
  it('ninguna migración escribe mobile_phone (sólo la 039 declara la columna)', () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        // 4O-H3-B la nombra por lo mismo: sus comentarios declaran que el merge humano NO
        // escribe `mobile_phone`. Nombrarla para prometer que no se toca es lo contrario de
        // tocarla — y es justo lo que esta lista distingue.
