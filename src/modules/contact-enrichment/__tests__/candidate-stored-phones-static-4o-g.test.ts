...
describe('4O-G — alcance', () => {
  ...
  it('4O-G no añade ninguna migración: el techo lo movió 4O-H3 con la 116', () => {
    ...
    // editar SQL, que es lo que esta guarda afirma. AUTORADA y NO APLICADA. RENUMERADA de 125
    // a 126 por BR-SOURCE CUT A.1, que insertó por debajo una migración 125 genérica
    // (reconciliación de `record_identity_key` sobre `source_company_snapshots`, fuentes NO
    // brasileñas) — tampoco toca la colección de teléfonos.
    ...
    // 126 archivos para los números 001-126: sigue SIN un solo hueco, y conteo y techo
