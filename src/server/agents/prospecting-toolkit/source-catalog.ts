...
export const CATALOG_SOURCES: CatalogSource[] = [
  ...
  },
  {
    ...
    nextAction: 'Revisar conexión real y rol en discovery B2G',
    countryCodes: ['CO'],
    sectors: [],
    priority: 'P1',
    operationalStatus: 'operational_verified',
  ...
  // ── Colombia — Tecnología (Hito 16Y.1) ─────────────────────────────────────
  {
    ...
    aiFlowStatus: 'partial_pending_data',
    connectionMode: 'automatic_enrichment',
    nextAction: 'Reintentar dry-run/carga snapshot Fedesoft cuando el sitio no esté detrás de captcha',
    countryCodes: ['CO'],
    ...
    automationLevel: 'high',
    recommendedUse: 'Discovery secundario del sector software y TI colombiano vía snapshot controlado. Conector REST y ETL snapshot implementados. Útil para enriquecimiento post-discovery con datos gremiales (categorías, ubicación, tamaño, solución, certificaciones). No debe usarse como live dependency del wizard — la carga depende de disponibilidad del sitio Fedesoft y puede pausarse si el upstream responde con captcha/protección. Usar exclusivamente desde snapshot controlado, no como consulta en vivo.',
    limitations: [
      ...
      'Conector REST y ETL snapshot existen, pero la carga depende de disponibilidad del sitio Fedesoft.',
      'Si Fedesoft responde con captcha/protección (SiteGround), la carga se pausa automáticamente.',
      'No usar como live dependency del wizard — usar snapshot controlado.',
    ],
    riskNotes: [
      ...
      'Usar exclusivamente snapshot controlado; no consultar en vivo contra el upstream.',
      'Conector y ETL implementados — el bloqueo actual es upstream (captcha), no falta de desarrollo.',
    ],
  },
  {
