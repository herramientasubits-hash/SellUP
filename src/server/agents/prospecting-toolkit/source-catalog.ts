...
export const CATALOG_SOURCES: CatalogSource[] = [
  ...
  // ── Perú ────────────────────────────────────────────────────────────────────
  {
    ...
    aiFlowStatus: 'connected',
    connectionMode: 'wizard_discovery',
    nextAction: 'Conectado como fuente estructurada. Preflight verifica disponibilidad del ZIP SUNAT. Requiere hito Perú.3 para descarga y parseo completo de registros.',
    countryCodes: ['PE'],
    sectors: [],
    priority: 'P0',
    operationalStatus: 'operational_verified',
